...
def get_prompt(prompt_name: str, **substitutions: str) -> str:
    path = _resolve_prompt_path(_PROMPTS_ROOT, _PARADIGM, prompt_name)
    return _load_prompt(path, **substitutions)
